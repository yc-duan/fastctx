...
const EN: ConfigMessages = config_messages!(
    ...
    "CPU limit",
    "Automatic",
    "Used by grep/glob; takes effect after the shared control center restarts. Reconnecting is not required.",
    "Edit CPU limit",
    "Enter 1..={maximum}:",
...
const ZH_CN: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自动",
    "用于 grep/glob；共享控制中心重启后生效。无需重新接入。",
    "编辑 CPU 限制",
    "输入 1..={maximum}：",
    "值不能为空。",
    "请输入整数。",
...
const ZH_TW: ConfigMessages = config_messages!(
    ...
    "CPU 限制",
    "自動",
    "用於 grep/glob；共享控制中心重啟後生效。不需要重新接入。",
    "編輯 CPU 限制",
    "輸入 1..={maximum}：",
    "值不可為空。",
    "請輸入整數。",
...
const JA: ConfigMessages = config_messages!(
    ...
    "CPU 制限",
    "自動",
    "grep/glob で使用。共有コントロールセンターの再起動後に適用されます。再接続は不要です。",
    "CPU 制限を編集",
    "1..={maximum} を入力:",
    "値は空にできません。",
    "整数を入力してください。",
...
const KO: ConfigMessages = config_messages!(
    ...
    "CPU 제한",
    "자동",
    "grep/glob에 사용되며 공유 제어 센터를 다시 시작한 후 적용됩니다. 다시 연결할 필요는 없습니다.",
    "CPU 제한 편집",
    "1..={maximum} 입력:",
    "값을 비워 둘 수 없습니다.",
    "정수를 입력하세요.",
...
const ES: ConfigMessages = config_messages!(
    ...
    "Límite de CPU",
    "Automático",
    "Se usa para grep/glob; se aplica tras reiniciar el centro de control compartido. No hace falta volver a conectar.",
...
const FR: ConfigMessages = config_messages!(
    ...
    "Automatique",
    "Utilisé par grep/glob ; s’applique après le redémarrage du centre de contrôle partagé. Aucune reconnexion nécessaire.",
...
const DE: ConfigMessages = config_messages!(
    ...
    "CPU-Limit",
    "Automatisch",
    "Für grep/glob verwendet; gilt nach dem Neustart der gemeinsamen Steuerzentrale. Neu verbinden ist nicht erforderlich.",
...
const PT_BR: ConfigMessages = config_messages!(
    ...
    "Limite de CPU",
    "Automático",
    "Usado por grep/glob; entra em vigor após reiniciar a central de controle compartilhada. Não é necessário reconectar.",
...
const RU: ConfigMessages = config_messages!(
    ...
    "Лимит ЦП",
    "Автоматически",
    "Используется grep/glob; действует после перезапуска общего центра управления. Переподключение не требуется.",
    "Изменить лимит ЦП",
    "Введите 1..={maximum}:",
...
const IT: ConfigMessages = config_messages!(
    ...
    "Limite CPU",
    "Automatico",
    "Usato da grep/glob; vale dopo il riavvio del centro di controllo condiviso. Non serve ricollegare.",
    "Modifica limite CPU",
    "Inserisci 1..={maximum}:",
...
const TR: ConfigMessages = config_messages!(
    ...
    "CPU sınırı",
    "Otomatik",
    "grep/glob tarafından kullanılır; paylaşılan kontrol merkezi yeniden başlatıldıktan sonra uygulanır. Yeniden bağlanmak gerekmez.",
...
const PL: ConfigMessages = config_messages!(
    ...
    "Limit CPU",
    "Automatycznie",
    "Używany przez grep/glob; obowiązuje po ponownym uruchomieniu współdzielonego centrum sterowania. Ponowne połączenie nie jest wymagane.",
    "Edytuj limit CPU",
    "Wpisz 1..={maximum}:",
...
const NL: ConfigMessages = config_messages!(
    ...
    "CPU-limiet",
    "Automatisch",
    "Gebruikt door grep/glob; geldt na herstart van het gedeelde controlecentrum. Opnieuw verbinden is niet nodig.",
    "CPU-limiet bewerken",
    "Voer 1..={maximum} in:",
...
const VI: ConfigMessages = config_messages!(
    ...
    "Giới hạn CPU",
    "Tự động",
    "Dùng cho grep/glob; có hiệu lực sau khi khởi động lại trung tâm điều khiển dùng chung. Không cần kết nối lại.",
    "Chỉnh giới hạn CPU",
    "Nhập 1..={maximum}:",
...
const ID: ConfigMessages = config_messages!(
    ...
    "Batas CPU",
    "Otomatis",
    "Digunakan oleh grep/glob; berlaku setelah pusat kontrol bersama dimulai ulang. Tidak perlu hubungkan ulang.",
    "Edit batas CPU",
    "Masukkan 1..={maximum}:",
...
const UK: ConfigMessages = config_messages!(
    ...
    "Ліміт ЦП",
    "Автоматично",
    "Використовується grep/glob; діє після перезапуску спільного центру керування. Повторне підключення не потрібне.",
    "Редагувати ліміт ЦП",
    "Введіть 1..={maximum}:",
